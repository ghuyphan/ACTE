...
const EMOJI_RULES: EmojiRule[] = [
  ...
  {
    emoji: '🎮',
    keywords: ['game', 'games', 'gaming', 'arcade', 'board game', 'board games', 'console', 'playstation', 'switch'],
    score: 3,
  },
  {
    emoji: '🛍️',
  ...
  {
    emoji: '💅',
    keywords: ['salon', 'nails', 'manicure', 'pedicure', 'haircut', 'hair salon', 'blowout', 'makeup', 'skincare'],
    score: 3,
  },
  {
    emoji: '🏡',
  ...
  {
    emoji: '🚗',
    keywords: ['drive', 'driving', 'road trip', 'roadtrip', 'parking', 'car', 'taxi', 'grab', 'ride', 'motorbike'],
    score: 3,
  },
  {
    emoji: '🚇',
  ...
  {
    emoji: '🌃',
    keywords: ['night market', 'neon', 'city lights', 'after dark', 'late night', 'night walk', 'night view'],
    score: 3,
  },
  {
    emoji: '🌧️',
