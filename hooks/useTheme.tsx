...
const classicPalette: ThemePalette = {
    ...
    dark: {
        ...
        card: '#2B251E',
        text: '#FFF7EC',
        secondaryText: '#C8B9A5',
        inverseText: '#FFFFFF',
        primary: '#F2C96F',
        primarySoft: 'rgba(242, 201, 111, 0.2)',
        onPrimary: '#2A2116',
        accent: '#F19A7A',
        border: '#3D342A',
        danger: '#FF8A80',
        ...
        onDanger: '#FFFFFF',
        success: '#7DCD91',
        gradient: ['#F2C96F', '#F19A7A'],
        captureGradient: ['#F2C96F', '#F19A7A'],
        chromeSurface: 'rgba(255,247,236,0.08)',
        chromeBorder: 'rgba(255,247,236,0.14)',
        noticeSurface: 'rgba(255,247,236,0.07)',
        noticeBorder: 'rgba(255,247,236,0.1)',
        glassOverlaySurface: 'rgba(43,37,30,0.5)',
        glassOverlayBorder: 'rgba(255,247,236,0.16)',
        glassBackdrop: 'rgba(22,19,16,0.6)',
        captureButtonBg: '#FFF7EC',
        tabBarBg: 'rgba(22,19,16,0.92)',
        captureCardText: '#2B251E',
        captureCardPlaceholder: 'rgba(43,37,30,0.5)',
        captureCardBorder: 'rgba(255,247,236,0.16)',
        captureGlassFill: 'rgba(43,37,30,0.34)',
        captureGlassBorder: 'rgba(255,247,236,0.16)',
        captureGlassText: '#FFF7EC',
        captureGlassIcon: 'rgba(255,247,236,0.78)',
        captureGlassPlaceholder: 'rgba(255,247,236,0.56)',
        captureGlassColorScheme: 'dark',
        captureCameraOverlay: 'rgba(22,19,16,0.7)',
        captureCameraOverlayBorder: 'rgba(255,247,236,0.14)',
        captureCameraOverlayText: '#FFF7EC',
        captureFlashOverlay: 'rgba(0,0,0,0.9)',
        androidTabShellBackground: 'rgba(34,29,24,0.74)',
        androidTabShellBorder: 'rgba(255,247,236,0.12)',
        androidTabShellShadow: 'rgba(0,0,0,0.26)',
        androidTabShellScrim: 'rgba(34,29,24,0.24)',
        androidTabShellMutedBackground: 'rgba(255,247,236,0.1)',
        androidTabShellMutedBorder: 'rgba(255,247,236,0.12)',
        androidTabShellSelectedBackground: 'rgba(242,201,111,0.2)',
        androidTabShellSelectedBorder: 'rgba(242,201,111,0.24)',
        androidTabShellSelectedGradient: ['rgba(242,201,111,0.24)', 'rgba(241,154,122,0.12)'],
        androidTabShellActive: '#F2C96F',
        androidTabShellInactive: 'rgba(255,247,236,0.7)',
    },
};
