...
This file (`SKILL.md`) serves as a comprehensive guide and context rule sheet for any subsequent AI agents (or human developers) working on **Noto**. Follow these exact best practices when iterating or adding features to this repository.
...
*Follow these principles to ensure consistency, fast iterations, and a cohesive user experience across Noto.*
